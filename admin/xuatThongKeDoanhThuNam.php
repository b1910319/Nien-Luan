<?php
    ...
    $pdf->Cell(0,10,'BAO CAO THONG KE DOANH THU THEO NAM', 0,1, 'C', );
    ...
    if ($thongke_danhthu_nam){
        while($resultTK = $thongke_danhthu_nam->fetch_assoc()){
            ...
            $pdf->Cell(50,10,$resultTK['nam_thongke'],1,0,'C');
            $pdf->Cell(50,10,$resultTK['tongban_nam'],1,0, 'C');
            $pdf->MultiCell(65,10,$resultTK['tongtien_nam'] ,1,'C');
        }
    }
    $pdf->SetFont('Arial','B',11);
